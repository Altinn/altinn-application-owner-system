...
namespace AltinnApplicationOwnerSystem.Functions
{
    ...
    public class EventsSubscriber
    {
        ...
        public async Task Run(
            [BlobTrigger("add-subscriptions/{name}.json", Connection = "QueueStorageSettings:ConnectionString")] byte[] blob, // Use byte[] https://github.com/Azure/azure-functions-dotnet-worker/issues/398
            string name)
        {
